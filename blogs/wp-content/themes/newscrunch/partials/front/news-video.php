									...
									<div class="spnc-content-wrapper">
										<div class="spnc-post-wrapper">
											<div class="spnc-video-popup">
												<?php
												if(( get_post_format($array[$i]) === 'video') && (!empty($newscrunch_featured_video_url))) { ?>
													<a href="<?php	if(str_contains($newscrunch_featured_video_url, '&')) { echo strstr($newscrunch_featured_video_url, '&', true); } else { echo $newscrunch_featured_video_url; } ?>" class="spncOpenVideo popup-youtube1" title="<?php esc_attr_e('Video Popup','newscrunch'); ?>"><i class="fas fa-solid fa-play"></i></a>
												<?php } 
												else
												{ 
									...
									<div class="spnc-post-img <?php echo esc_attr(get_theme_mod('img_animation','i_effect1'));?>"
										...
										<div class="spnc-post-content">
											<div class="spnc-content-wrapper">
												<div class="spnc-post-wrapper">
													<div class="spnc-video-popup">
														<?php if(( get_post_format($array[$i]) === 'video') && (!empty($newscrunch_featured_video_url))) { ?>
															<a href="<?php	if(str_contains($newscrunch_featured_video_url, '&')) { echo strstr($newscrunch_featured_video_url, '&', true); } else { echo $newscrunch_featured_video_url; } ?>" class="spncOpenVideo popup-youtube2" title="<?php esc_attr_e('Video Popup','newscrunch'); ?>"><i class="fas fa-solid fa-play"></i></a>
														<?php }
														else 
														{ if($newscrunch_array_video_url[$i] != ''): ?>
										...
										<div class="spnc-post-content">
											<div class="spnc-content-wrapper">
												<div class="spnc-post-wrapper">
													<div class="spnc-video-popup">
														<?php if(( get_post_format($array[$i]) === 'video') && (!empty($newscrunch_featured_video_url))) { ?>
															<a href="<?php	if(str_contains($newscrunch_featured_video_url, '&')) { echo strstr($newscrunch_featured_video_url, '&', true); } else { echo $newscrunch_featured_video_url; } ?>" class="spncOpenVideo popup-youtube3" title="<?php esc_attr_e('Video Popup','newscrunch'); ?>"><i class="fas fa-solid fa-play"></i></a>
														<?php }
														else 
														{	if($newscrunch_array_video_url[$i] != ''): ?>
