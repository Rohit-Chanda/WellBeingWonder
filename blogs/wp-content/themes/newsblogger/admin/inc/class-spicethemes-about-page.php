	...
	class NewsBlogger_About_Page {
		...
		public function get_plugin_buttion($slug, $name) {
			...
			if (!$is_installed) {
    			...
    			{
    				$op_string=esc_html__('Install and activate', 'newsblogger' );
    			}
    			else
    			{
    				$op_string=esc_html__('Import Demo', 'newsblogger' );
    			}
...
function newsblogger_recommended_plugins_array($plugins){
		...
		$plugins[] = array(
			...
			'desc'     	=> esc_html__('To import the pre-designed demo data for the magazine theme, please install and activate this plugin.', 'newsblogger' ),
		);
		$plugins[] = array(
			'name'     	=> 'Contact Form 7',
			'slug'     	=> 'contact-form-7',
